"""Stage 3: Root-Cause Diagnosis & Remediation.

Builds a reasoning layer on top of Stages 1-2 classification results.
...
Three analysis components:
  ...
  C) Per-Sample Diagnostic Reasoning -- given Stage-2 predictions, generates structured
...
Usage:
  python run_stage3_diagnosis.py              # full run
  python run_stage3_diagnosis.py --arch enc   # encoder only
"""
...
def main():
    ...
    p.add_argument(
        "--feature_core_map",
        type=Path,
        default=(ROOT / "src" / "diagnosis_root_cause" / "ndg_stage3" / "feature_core_map.md"),
