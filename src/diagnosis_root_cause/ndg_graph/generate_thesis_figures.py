...
enc_det = load("detection/enc_detection.json")
dec_det = load("detection/dec_detection.json")
enc_cat = load("categorization/enc_categorization.json")
dec_cat = load("categorization/dec_categorization.json")
xai_enc = load("explanations/xai_enc_categorization.json")
xai_dec = load("explanations/xai_dec_categorization.json")
...
def fig_insight_xai_shift():
    ...
    try:
        from ndg_graph.mapping import display_name
