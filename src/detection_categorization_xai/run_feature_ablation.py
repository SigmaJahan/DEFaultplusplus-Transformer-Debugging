"""Feature family ablation for fault categorization.
...
Self-contained version for Compute Canada.
  python run_feature_ablation.py --arch both
"""
...
def run_ablation(arch_prefix):
    ...
    print(f"\n{'='*60}")
    print(f"  FEATURE ABLATION: {arch_name.upper()}")
...
def main():
    p = argparse.ArgumentParser(description="Feature family ablation")
