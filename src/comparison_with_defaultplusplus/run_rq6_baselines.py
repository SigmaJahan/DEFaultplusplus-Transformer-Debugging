...
RESULTS_DIR = REPO_ROOT / "results" / "rq6"
DIAG_DIR = REPO_ROOT / "results" / "stage_3_diagnosis"
...
def plot_categorization_bars(cat_results):
    ...
    plt.tight_layout()
    plt.savefig(PLOTS_DIR / "rq6_categorization_comparison.pdf", bbox_inches="tight", dpi=150)
    plt.savefig(PLOTS_DIR / "rq6_categorization_comparison.png", bbox_inches="tight", dpi=150)
    plt.close()
...
def plot_detection_bars(det_results):
    ...
    plt.tight_layout()
    plt.savefig(PLOTS_DIR / "rq6_detection_comparison.pdf", bbox_inches="tight", dpi=150)
    plt.savefig(PLOTS_DIR / "rq6_detection_comparison.png", bbox_inches="tight", dpi=150)
    plt.close()
...
def plot_coverage_vs_performance(cat_results):
    ...
    plt.tight_layout()
    plt.savefig(PLOTS_DIR / "rq6_coverage_vs_performance.pdf", bbox_inches="tight", dpi=150)
    plt.savefig(PLOTS_DIR / "rq6_coverage_vs_performance.png", bbox_inches="tight", dpi=150)
    plt.close()
...
def plot_feature_heatmap(cat_results):
    ...
    plt.tight_layout()
    plt.savefig(PLOTS_DIR / "rq6_feature_coverage_heatmap.pdf", bbox_inches="tight", dpi=150)
    plt.savefig(PLOTS_DIR / "rq6_feature_coverage_heatmap.png", bbox_inches="tight", dpi=150)
    plt.close()
...
def plot_per_class_f1(cat_results):
    ...
    plt.tight_layout()
    plt.savefig(PLOTS_DIR / "rq6_per_class_f1.pdf", bbox_inches="tight", dpi=150)
    plt.savefig(PLOTS_DIR / "rq6_per_class_f1.png", bbox_inches="tight", dpi=150)
    plt.close()
...
def main():
    ...
    with open(RESULTS_DIR / "rq6_detection_results.json", "w") as f:
        json.dump(det_results, f, indent=2, default=str)
    with open(RESULTS_DIR / "rq6_categorization_results.json", "w") as f:
        json.dump(cat_results, f, indent=2, default=str)
    with open(RESULTS_DIR / "rq6_graph_results.json", "w") as f:
    ...
    with open(RESULTS_DIR / "rq6_summary.json", "w") as f:
        json.dump(summary, f, indent=2, default=str)

    latex = generate_latex_tables(det_results, cat_results, graph_results)
    with open(RESULTS_DIR / "rq6_latex_tables.tex", "w") as f:
        f.write(latex)
    print(f"  LaTeX tables: {RESULTS_DIR / 'rq6_latex_tables.tex'}")
