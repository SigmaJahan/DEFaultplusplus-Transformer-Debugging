...
VARIANT_COLORS = {
    ...
    "graph": "#0072B2",
    "sibling": "#E69F00",
    "graph_sibling": "#D55E00",
    "graph+sibling": "#D55E00",
}

VARIANT_LABELS = {
    "basic": "Basic",
    "graph": "+ Graph (FPG)",
    "sibling": "+ intra-family contrastive Loss",
    "graph_sibling": "Full Method",
    "graph+sibling": "Full Method",
}
...
def plot_rootcause_comparison(emb_basic, emb_sibling, rc_labels, rc_names,
                              category_name, path):
    """Side-by-side root-cause clusters: without vs with intra-family contrastive loss."""
    if len(emb_basic) < 10:
        return
    ...
    for ax, emb, subtitle in [(ax1, emb_basic, "Without intra-family contrastive loss"),
                               (ax2, emb_sibling, "With intra-family contrastive loss")]:
