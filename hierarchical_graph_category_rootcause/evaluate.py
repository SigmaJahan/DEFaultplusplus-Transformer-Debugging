...
Usage:
    python experiments/hierarchical_graph_category_rootcause/evaluate.py --arch encoder
    python experiments/hierarchical_graph_category_rootcause/evaluate.py --arch both
"""
import argparse
import json
import pickle
...
DEFAULT_RESULTS_DIR = _ROOT / "results" / "hierarchical_graph_category_rootcause"
