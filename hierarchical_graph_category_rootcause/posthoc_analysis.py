...
Usage:
    python experiments/hierarchical_graph_category_rootcause/posthoc_analysis.py --arch encoder
    python experiments/hierarchical_graph_category_rootcause/posthoc_analysis.py --arch both
"""
import argparse
import json
import sys
...
from plotting import (plot_explanation_barplot, plot_explanation_heatmap,
                      COLUMN_WIDTH, CATEGORY_COLORS, DPI, _save)
